...
begin
	...
	function diffeq!(du, u, p, t)
	    return du[1] = (Δp - d̂!(u[1], p[3])) / m̂!(u[1], p[5])
	end
	
	nsim = sims_all[1]
	u0 = nsim["u0"]
	
	diffeqd!(du, u, p, t) = diffeq!(du, u, [nsim["Δp"], 1.0, p, 1.0, mθ], t)
	diffeqm!(du, u, p, t) = diffeq!(du, u, [nsim["Δp"], 1.0, dθ, 1.0, p], t)
...
# ╔═╡ 4b473e26-d8fd-4de5-bcd6-1256224d1ba6
md""" ### Literature coefficient"""
