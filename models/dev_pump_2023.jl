...
# Based on: dev_pump_simple_trial.jl
...
# Pipeline elements
@named plm = Mass()
@named pld = Damper()     # General damping element
@named pls = Spring()     # General compliance element
...
# Pipeline assembly
cons = [connect(us11.power, us10.power)]
push!(cons, connect(ds11.power, ds10.power))
